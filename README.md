Just a test/demonstration of deploying a simple frontend to Google Cloud Run, built with GitHub Actions, pushed to Google Cloud Artifact Registry, and deployed on Google Cloud Run.
